...
var partyIngredients: [String] = ["Chips", "Salsa", "Guacamole", "Red Wine"]
...
for ingredient in partyIngredients {
    print(ingredient)
}
...
let names = ["Steven", "Michael", "McGrath"]
...
var nums = [1,3,5,7,9,49,50,51,52,53]

print(lessThanFifty(numbers: nums))
